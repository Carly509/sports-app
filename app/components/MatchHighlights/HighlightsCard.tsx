    ...
    <div className="bg-[#1e1c1c] p-4">
      ...
      <div className="h-[230px] relative z-[10]">
        ...
        <div
          ...
          className="w-[4rem] h-[4rem] absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] flex items-center justify-center flex-col bg-black hover:bg-red-600 rounded-full transition-all duration-300 cursor-pointer"
        >
